/*
 * File: app/store/ComboClusterStore.js
 *
...
Ext.define('MyApp.store.ComboClusterStore', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoLoad: false,
            model: 'MyApp.model.ClusterModel',
            storeId: 'ComboClusterStore',
            proxy: me.processMyAjaxProxy({
                type: 'ajax',
                url: 'rhevm/hostcluster',
                reader: {
                    type: 'json',
                    root: 'list'
                }
