...
Ext.define('MyApp.controller.FeedController', {
    ...
    onDataviewViewReady: function(dataview, eOpts) {
        dataview.getSelectionModel().select(dataview.store.first());
    },

    onOpenAddFeedWindow: function(button, e, eOpts) {
        var win = Ext.create('widget.feedwindow');
        win.show();
    },

    onFeedWindowCancel: function(button, e, eOpts) {
        this.getFeedWindow().destroy();
    },

    onAddFeed: function(button, e, eOpts) {
    ...
    onRemoveFeed: function(button, e, eOpts) {
    ...
    onSummaryToggle: function(button, pressed, eOpts) {
        button.up('feedgrid').down('#view').getPlugin('preview').toggleExpanded(pressed);
    },

    onReadingPaneChange: function(cycle, item, eOpts) {
    ...
    onOpenAll: function(button, e, eOpts) {
    ...
    onGotoPostClick: function(button, e, eOpts) {
        var post = button.up('feedpost');

        window.open(post.active.get('link'));
    },

    onViewInTabClick: function(button, e, eOpts) {
        var post = button.up('feedpost');
