...
CREATE TABLE IF NOT EXISTS `peacock`.`software_tbl` (
  `MACHINE_ID` VARCHAR(36) NOT NULL,
  `SOFTWARE_ID` INT NOT NULL,
  `INSTALL_SEQ` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  `UPD_USER_ID` INT(11) NULL,
  `UPD_DT` DATETIME NULL,
  PRIMARY KEY (`INSTALL_SEQ`, `MACHINE_ID`, `SOFTWARE_ID`),
...
CREATE TABLE IF NOT EXISTS `peacock`.`config_tbl` (
  ...
  `UPD_USER_ID` INT(11) NULL,
  `UPD_DT` DATETIME NULL,
  PRIMARY KEY (`MACHINE_ID`, `SOFTWARE_ID`, `CONFIG_FILE_ID`, `INSTALL_SEQ`),
  INDEX `fk_config_tbl_software_tbl1_idx` (`INSTALL_SEQ` ASC),
  CONSTRAINT `fk_config_tbl_software_tbl1`
    FOREIGN KEY (`INSTALL_SEQ`)
    REFERENCES `peacock`.`software_tbl` (`INSTALL_SEQ`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `peacock`.`alm_project_mapping_tbl` (
  ...
  `EXIT_MESSAGE` VARCHAR(1000) NULL,
...
-- -----------------------------------------------------
-- Table `peacock`.`ceph_tbl`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `peacock`.`ceph_tbl` (
  `CEPH_ID` INT(11) NOT NULL,
  `MACHINE_ID` VARCHAR(36) NULL,
  `MGMT_HOST` VARCHAR(45) NULL,
  `MGMT_PORT` VARCHAR(45) NULL,
  `MGMT_USERNAME` VARCHAR(45) NULL,
  `MGMT_PASSWORD` VARCHAR(45) NULL,
  `MGMT_API_PREFIX` VARCHAR(100) NULL,
  `RADOSGW_API_PREFIX` VARCHAR(100) NULL,
  `CALAMARI_API_PREFIX` VARCHAR(100) NULL,
  `CALAMARI_USERNAME` VARCHAR(45) NULL,
  `CALAMARI_PASSWORD` VARCHAR(45) NULL,
  ...
  `UPD_DT` DATETIME NULL,
  PRIMARY KEY (`CEPH_ID`),
  INDEX `fk_ceph_tbl_machine_tbl1_idx` (`MACHINE_ID` ASC),
  CONSTRAINT `fk_ceph_tbl_machine_tbl1`
    FOREIGN KEY (`MACHINE_ID`)
    REFERENCES `peacock`.`machine_tbl` (`MACHINE_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
