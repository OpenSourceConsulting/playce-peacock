...
/**
 * 
 * Eclipse .settings/org.eclipse.wst.common.component 파일 수정 Handler.
 * 
 * @author Bong-Jin Kwon
 *
 */
public class WstFileReplaceHandler extends AbstractFileReplaceHandler {

	
	public WstFileReplaceHandler() {
		setFilePath(".settings/org.eclipse.wst.common.component");
	}
	...
	public void replaceFile(String projectRootDir, String projectCode) {
		...
		task.setMatch("<wb-module deploy-name=\"(.*)\">");
		task.setReplace("<wb-module deploy-name=\""+projectCode+"\">");
