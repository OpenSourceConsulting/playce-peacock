...
public class MapObject {
	...
	protected int getInt(String key) {
		...
		throw new IllegalStateException("Field '" + key
				+ "' is of unknown type: " + o.getClass().getName());
	}
	...
	protected void setBoolean(String key, String value) {
		boolean b = (value.equalsIgnoreCase("true") || value.equals("1") || value
	...
	private void checkXmlRpcTypes(Object object) {
		...
		if (!checkPassed) {
			throw new IllegalStateException("Object '" + object.toString()
					+ "' has a not supported type "
