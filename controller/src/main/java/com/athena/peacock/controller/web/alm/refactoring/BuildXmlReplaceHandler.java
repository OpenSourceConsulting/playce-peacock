...
/**
 * 
 * Ant build.xml 파일 수정 Handler.
 * 
 * @author Bong-Jin Kwon
 *
 */
public class BuildXmlReplaceHandler extends AbstractFileReplaceHandler {

	
	public BuildXmlReplaceHandler() {
		setFilePath("build.xml");
	}
	...
	public void replaceFile(String projectRootDir, String projectCode) {
		...
		task.setMatch("<project name=\"(.*)\"");
		task.setReplace("<project name=\""+projectCode.toLowerCase()+"\"");
