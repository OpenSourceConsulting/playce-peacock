...
public class DashboardController {
	...
	public @ResponseBody DtoJsonResponse main(DtoJsonResponse jsonRes) throws Exception {
		DashboardDto dashboard = (DashboardDto) ThreadLocalUtil.get(DashboardService.DASH_BOARD);
				
		if (dashboard == null) {
			dashboard = dashboardService.getDashboardInfo();
			ThreadLocalUtil.add(DashboardService.DASH_BOARD, dashboard);
		}
		
		jsonRes.setData(dashboard);
