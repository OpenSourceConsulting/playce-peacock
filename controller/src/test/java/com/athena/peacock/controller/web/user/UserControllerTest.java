...
public class UserControllerTest extends BaseControllerTest {
    ...
    public void testCreate() throws Exception {
    	try {
			mockMvc.perform(get("/user/create")
					.param("userId", "jchoi")
					.param("loginId", "jchoi")
					.param("userName", "Ji-Woong Choi")
					.param("passwd", "opensource")
					.param("deptName", "Consulting")
    ...
    public void testUpdateMyAccount() throws Exception {
    	try {
			mockMvc.perform(get("/user/updateMyAccount")
					.param("userId", "jchoi")
					.accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
					.andDo(print())
					.andExpect(status().isOk());
    ...
    public void testGetMyAccount() throws Exception {
    	try {
			mockMvc.perform(get("/user/getMyAccount")
					.param("userId", "admin")
					.accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
					.andDo(print())
					.andExpect(status().isOk());
    ...
    public void testLogout() throws Exception {
    	try {
			mockMvc.perform(get("/user/onAfterLogout")
					.accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
					.andDo(print())
					.andExpect(status().isOk());
		} catch (Exception e) {
	...
	@Test
    public void testOnAfterLogin() throws Exception {
    	try {
			mockMvc.perform(get("/user/onAfterLogin")
					.accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
					.andDo(print())
					.andExpect(status().isOk());
		} catch (Exception e) {
    ...
    public void testAccessDenied() throws Exception {
    	try {
			mockMvc.perform(get("/user/accessDenied")
					.accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
					.andDo(print())
					.andExpect(status().isOk());
		} catch (Exception e) {
    ...
    public void testLoginFail() throws Exception {
    	try {
			mockMvc.perform(get("/user/loginFail")
					.accept(MediaType.parseMediaType("application/json;charset=UTF-8")))
					.andDo(print())
					.andExpect(status().isOk());
		} catch (Exception e) {
